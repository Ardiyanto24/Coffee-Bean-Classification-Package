...
class TestDataConfig:
    ...
    def test_validation_invalid_ratio(self, tmp_path):
        ...
        config = DataConfig(dataset_path=str(tmp_path), split_ratio=(0.6, 0.3, 0.2))  # Sum > 1.0
...
class TestTrainingConfig:
    ...
    def test_init_custom(self):
        """Test initialization with custom parameters."""
        config = TrainingConfig(epochs=100, batch_size=64, learning_rate=0.0001, seed=123)
    ...
    def test_nested_configs(self, tmp_path):
        ...
        training_config = TrainingConfig(data_config=data_config, model_config=model_config)
    ...
    def test_quick_start(self, tmp_path):
        ...
        config = TrainingConfig.quick_start(
            dataset_path=str(tmp_path), architecture="efficientnet_b0", num_classes=4, epochs=30
        )
    ...
    def test_save_load_nested(self, tmp_path):
        ...
        config = TrainingConfig(epochs=100, data_config=data_config, model_config=model_config)
