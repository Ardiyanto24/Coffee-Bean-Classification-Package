...
class ClassificationEvaluator:
    ...
    def __init__(
        self, model: tf.keras.Model, class_names: List[str], output_dir: Optional[str] = None
    ):
        """
    ...
    def evaluate(self, dataset: tf.data.Dataset, verbose: int = 1) -> Dict[str, Any]:
        """
        ...
        self.y_pred = (self.y_pred_proba == self.y_pred_proba.max(axis=1, keepdims=True)).astype(
            int
        )
    ...
    def plot_confusion_matrix(
        self, normalized: bool = True, save_path: Optional[str] = None, figsize: tuple = (10, 8)
    ) -> None:
        """
    ...
    def plot_per_class_metrics(
        self, save_path: Optional[str] = None, figsize: tuple = (12, 6)
    ) -> None:
        """
    ...
    def plot_roc_curves(self, save_path: Optional[str] = None, figsize: tuple = (10, 8)) -> None:
        """
    ...
    def get_misclassified_samples(
        self, dataset: tf.data.Dataset, max_samples: int = 10
    ) -> List[Dict[str, Any]]:
        """
